    ...
    <fieldset class="uk-fieldset">
      ...
      <div uk-dropdown="mode: click">
        <ul class="uk-nav uk-dropdown-nav">
          ...
          <li>
            <a class="uk-text-muted" href={'#'} on:click={() => setLocale('pt')}>Portuguese</a>
          </li>
